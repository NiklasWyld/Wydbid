...
def delMitarbeiterFinal(username: str, passwort: str, widget: QWidget):
    ...
    readable_file = open(f'{Wydbid.firmen_location}Mitarbeiter/{username}.wbm', 'rb')
    ...
    QMessageBox.about(Wydbid.app.parent(), 'Abgeschlossen', 'Der Mitarbeiter wurde gelöscht!')
